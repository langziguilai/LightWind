...
package com.app.browser_components.service.telemetry.schedule.jobscheduler;
...
import com.app.browser_components.service.telemetry.TelemetryHolder;
...
public class TelemetryJobService extends JobService {
    ...
    @VisibleForTesting
    boolean isSameDay(long timestamp1, long timestamp2) {
